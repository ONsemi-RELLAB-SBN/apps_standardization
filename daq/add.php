...
<html lang="en" class="no-js">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="three columns">
                        <select id="standardization" name="standardization" style="width: 100%" required>
                            <?php echo getDropdown('004', '004003'); ?>
                        </select>
                    </div>
                    <div class="one columns">&nbsp;</div>
            ...
            <div id="content-page">
                ...
                <div class="tab-content active" id="tabIdentity">
                    ...
                    <div class="row">
                        ...
                        <div class="three columns">
                            <input type="text" list="daq_list" autocomplete="off" id="daq_id" name="daq_id" required>
                            <datalist id="daq_list">
                                <?php echo getDataList('024', ''); ?>
                            </datalist>
                        </div>
                        <div class="one columns">&nbsp;</div>
                    </div>
                ...
                <div class="tab-content" id="tabCapacity">
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="no_temp_channel" name="no_temp_channel" value="" > </div>
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="no_volt_channel" name="no_volt_channel" value="" > </div>
                    ...
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="no_leakage_channel" name="no_leakage_channel" value="" > </div>
                ...
                <div class="tab-content" id="tabCapability">
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="max_voltage" name="max_voltage" value="" > </div>
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="min_voltage" name="min_voltage" value="" > </div>
                    ...
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="max_leakage" name="max_leakage" value="" > </div>
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="min_leakage" name="min_leakage" value="" > </div>
                    ...
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="scan_time" name="scan_time" value="" > </div>
                    ...
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="leakage_measure_reso" name="leakage_measure_reso" value="" > </div>
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="leakage_measure_accuracy" name="leakage_measure_accuracy" value="" > </div>
                    ...
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="volt_measure_reso" name="volt_measure_reso" value="" > </div>
                ...
                <div class="tab-content" id="tabCharacter">
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="analog_input_single" name="analog_input_single" value="" > </div>
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="analog_input_diff" name="analog_input_diff" value="" > </div>
                    ...
                    <div class="row">
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="resolution" name="resolution" value="" > </div>
                        ...
                        <div class="two columns"><input type="number" step="0.001" id="sampling_frequency" name="sampling_frequency" value="" > </div>
        ...
        <script>
                ...
                const form = document.getElementById('add_daq_form');
