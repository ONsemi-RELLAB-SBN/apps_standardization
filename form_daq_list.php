...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="sample-form">
                ...
                while ($row_slides = mysqli_fetch_array($run_slides)):
                    ...
                    <tbody>
                        ...
                        <td style="text-align:center">
                            ...
                            <a href="form_daq_copy.php?edit=<?php echo $row_slides['id']; ?>" title="Replicate Record" data-toggle="tooltip"><i class='bx bx-repeat bx-fw'></i></i> COPY </a>
                        </td>
                    </tbody>
                    <?php
                endwhile;
            ...
            <button onclick="location.href = 'form_daq.php'" type="button" id="addBtn"><i class='bx bx-plus bx-fw'></i> Add New Equipment</button>
        </div>
    </body>
</html>