                        ...
                        <div class="accordion-item">
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="two columns"><input type="number" step="0.001" id="mb_dimension_t" name="mb_dimension_t" value="<?php echo $rowForm['mb_dimension_t']; ?>" required> </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="three columns"><input type="text" id="conn_type" name="conn_type" value="<?php echo getParameterValue($rowForm['connector_type']); ?>" required> </div>
                                    <div class="one columns">&nbsp;</div>
                                    <div class="two columns">
