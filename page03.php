...
<html lang="en">
    ...
    <body>
        <div class="penuh row">
            <div class="column1 imej1">
                <header class="header_section text-center text-orange">
                    <div class="desk">
                        <nav>
                            <a class="navbar-brand">
                                <span class="desk">ONSEMI APPLICATION - SSO</span>
                            </a>
                        </nav>
                    </div>
                </header>
                <div class="container">
                    <?php
                        $get_slides = "SELECT * FROM apps_info WHERE type = 'SSO' ORDER BY NAME ASC";
        ...
        <footer>
            <div class="copyright py-4 text-center text-white">
                ...
                <a href="page02.php" class="toggle-icon2"> <i class='bx bxl-visual-studio' style="float: right; padding-right: 20px;"></i> </a>
            </div>
        </footer>
    </body>
</html>