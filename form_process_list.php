...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="sample-form">
                    ...
                    while ($row_slides = mysqli_fetch_array($run_slides)):
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                ...
                                <a href="form_process_delete.php?delete=<?php echo $row_slides['id']; ?>" title="Delete Record" data-toggle="tooltip"><i class='bx bxs-trash bx-fw' ></i> DELETE </a>
            ...
            <button onclick="location.href = 'form_process.php'" type="button" id="addBtn"><i class='bx bx-plus bx-fw'></i> Add New Equipment</button>
        </div>
    </body>
</html>