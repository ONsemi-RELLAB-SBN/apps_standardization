...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="../css/menureset.css"> <!-- CSS reset -->
        <link rel="stylesheet" href="../css/menustyle.css"> <!-- Resource style -->
...
<!--        <main class="cd-main-content">
        ...
        <script src="../js/menumain.js"></script> <!-- Resource jQuery -->
    </body>
</html>
