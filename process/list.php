                    ...
                    while ($row_slides = mysqli_fetch_array($run_slides)):
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="form_process_view.php?view=<?php echo $row_slides['id']; ?>" title="View Record" data-toggle="tooltip"><i class='bx bx-search-alt bx-fw'></i> VIEW </a>
                                <a href="form_process_edit.php?edit=<?php echo $row_slides['id']; ?>" title="Update Record" data-toggle="tooltip"><i class='bx bxs-pencil bx-fw' ></i> EDIT </a>
                                <a href="form_process_delete.php?delete=<?php echo $row_slides['id']; ?>" title="Delete Record" data-toggle="tooltip" onclick="return confirm('Are You Sure ?')"><i class='bx bxs-trash bx-fw' ></i> DELETE </a>
                                <a href="form_process_copy.php?edit=<?php echo $row_slides['id']; ?>" title="Replicate Record" data-toggle="tooltip"><i class='bx bx-copy bx-fw'></i></i> COPY </a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
            <button onclick="location.href = '../process/add.php'" type="button" id="addBtn"><i class='bx bx-plus bx-fw'></i> Add New Process</button>
