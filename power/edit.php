...
<html lang="en" class="no-js">
    ...
    <body>
                ...
                <div id="content-page">
                    ...
                    <div class="tab-content" id="tabCharacter">
                        ...
                        <div class="row">
                            ...
                            <div class="two columns"><input type="number" step="0.001" id="min_volt" name="min_volt" value="<?php echo $rowForm['min_voltage']; ?>" > </div>
                        ...
                        <div class="row">
                            ...
                            <div class="two columns"><input type="number" step="0.001" id="max_volt" name="max_volt" value="<?php echo $rowForm['max_voltage']; ?>" > </div>
        ...
        <script>
            ...
            const form = document.getElementById('update_power_form');
