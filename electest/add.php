...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <form id="add_test_form" action="crud_add_test.php" method="get">
            <div class="row">
                ...
                <button onclick="location.href = 'form_test_list.php'" type="button" id="backBtn"><i class='bx bx-list-ol bx-fw' ></i> List</button>
