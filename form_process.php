...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="twelve columns">&nbsp;</div>
        <h5 style="border-left: none;">Process Details</h5>
        <form id="add_process_form" action="crud_add_process.php" method="get">
            <div class="row">
                ...
                <button onclick="location.href = 'form_process_list.php'" type="button" id="backBtn"><i class='bx bx-list-ol bx-fw' ></i> List</button>
