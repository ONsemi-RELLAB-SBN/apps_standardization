...
if (isset($_POST["submit"])) {
    ...
    $title = $_POST['title'];
    $site = $_POST['site'];
    $sql = "UPDATE gest_user SET `oncid`='$oncid',`username`='$username', `name` = '$name',`email`='$email',`title`='$title', `site`='$site' WHERE id = $id";
                ...
                <form action="" method="post" style="width:50vw; min-width:300px;">
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="oncid" value="<?php echo $row['oncid'] ?>" maxlength="8">
                        </div>
                        <div class="col">
                            <label class="form-label">Username:</label>
                            <input type="text" class="form-control" name="username" value="<?php echo $row['username'] ?>" maxlength="6">
                        </div>
                    </div>
                    <div class="mb-3">
