...
<header class="l-header">
    <nav class="nav bd-grid">
        <div>
            <h5 style="border-left: none; padding-left: 100px;">Electrical Test Details</h5>
        </div>
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list" style="font-size: .7rem;">
                ...
                <li class="nav__item"><a href="#capacity"       class="nav__link">Capacity</a></li>
            </ul>
        </div>
