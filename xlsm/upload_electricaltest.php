...
//        echo '<pre>' . print_r($xlsx->sheetNames(), true) . '</pre>';
        ...
        if ($xlsx->sheetName(0) == 'ELECTRICALTEST') {
            ...
            echo 'You have uploaded an incorrect template. <br>The uploaded template is a ' . $xlsx->sheetName(0) . ' template, but the required template is an Electrical Test template. <br>Please check the files before uploading.
                    <br><br>Severity: Medium
                    <br>Action: Please upload the correct template [Electrical Test].';
        }
    } else {
