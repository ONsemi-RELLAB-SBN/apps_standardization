...
//        echo '<pre>' . print_r($xlsx->sheetNames(), true) . '</pre>';
        ...
        if ($xlsx->sheetName(0) == 'PROCESS') {
            ...
            echo 'You have uploaded an incorrect template. <br>The uploaded template is a ' . $xlsx->sheetName(0) . ' template, but the required template is an Process template. <br>Please check the files before uploading.
                    <br><br>Severity: Medium
                    <br>Action: Please upload the correct template [Process].';
        }
    } else {
