...
<html lang="en" class="no-js">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                ...
                var table = new DataTable('#example', {
                    ...
                    select:true,
                    ajax: { 
                        url: 'list/dao_test.php',
                        type: 'POST'
                    },
                    buttons: [
                        {
                            extend: 'copyHtml5',
                            title: 'Electrical Test Listing from Standardization Platform',
                            sheetName: 'ET'
                        },
                        {
                            extend: 'colvis',
    ...
    <body>
        <div class="table_list" style="overflow-x:auto;">
            ...
            <div class="row">&nbsp;</div>
            <div class="row">
                <h5 class="u-pull-left" style="border-left:none;padding-left:40px;">Electrical Test List</h5>
            </div>
