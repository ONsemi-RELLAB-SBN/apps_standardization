...
<html lang="en" class="no-js">
    ...
    <body>
        <form id="replicate_equipment_form" action="../crud/crud_add_equipment.php" method="get">
            <?php
...
//                                    toField.required = true;
                            ...
                            function updateRelTest() {
                                ...
                                var cp_vr4 = document.getElementById('labelvoltrating4');
                                ...
                                var cp_ct4 = document.getElementById('labelcoltcontrol4');
                                ...
                                var cp_cr4 = document.getElementById('labelcurrrating4');
                                ...
                                var cp_pw4 = document.getElementById('labelpowerrating4');
                                ...
                                var cp_mt7 = document.getElementById('labelmintimer4');
                                ...
                                var cp_mt8 = document.getElementById('labelmaxtimer4');
                                var cp_mt6 = document.getElementById('max_time');
                                
                                var cp_mtp11 = document.getElementById('labelmintemp1');
                                var cp_mtp12 = document.getElementById('labelmintemp2');
                                var cp_mtp13 = document.getElementById('labelmintemp3');
                                var cp_mtp14 = document.getElementById('labelmintemp4');
                                var cp_mtp15 = document.getElementById('labelmintemp5');
                                var cp_mtp16 = document.getElementById('labelmintemp6');
                                var cp_mtp17 = document.getElementById('labelmintemp7');
                                var cp_mtp18 = document.getElementById('labelmintemp8');
                                var cp_mtp19 = document.getElementById('labelmintemp9');
                                var cp_mtp21 = document.getElementById('labelmaxtemp1');
                                var cp_mtp22 = document.getElementById('labelmaxtemp2');
                                var cp_mtp23 = document.getElementById('labelmaxtemp3');
                                var cp_mtp24 = document.getElementById('labelmaxtemp4');
                                var cp_mtp25 = document.getElementById('labelmaxtemp5');
                                var cp_mtp26 = document.getElementById('labelmaxtemp6');
                                var cp_mtp27 = document.getElementById('labelmaxtemp7');
                                var cp_mtp28 = document.getElementById('labelmaxtemp8');
                                var cp_mtp29 = document.getElementById('labelmaxtemp9');
                                var cp_mtp1 = document.getElementById('min_temp');
                                var cp_mtp2 = document.getElementById('max_temp');
                                var cp_mtp3 = document.getElementById('min_temp_hot');
                                var cp_mtp4 = document.getElementById('max_temp_hot');
                                var cp_mtp5 = document.getElementById('min_temp_cold');
                                var cp_mtp6 = document.getElementById('max_temp_cold');
                                ...
                                if (reltest.includes('008016')) {
                                    ...
                                    cp_mtp11.style.display = 'block';
                                    cp_mtp12.style.display = 'block';
                                    cp_mtp13.style.display = 'block';
                                    cp_mtp21.style.display = 'block';
                                    cp_mtp22.style.display = 'block';
                                    cp_mtp23.style.display = 'block';
                                    cp_mtp3.style.display = 'none';
                                    cp_mtp4.style.display = 'none';
                                    cp_mtp5.style.display = 'none';
                                    cp_mtp6.style.display = 'none';
                                    cp_mtp14.style.display = 'none';
                                    cp_mtp15.style.display = 'none';
                                    cp_mtp16.style.display = 'none';
                                    cp_mtp17.style.display = 'none';
                                    cp_mtp18.style.display = 'none';
                                    cp_mtp19.style.display = 'none';
                                    cp_mtp24.style.display = 'none';
                                    cp_mtp25.style.display = 'none';
                                    cp_mtp26.style.display = 'none';
                                    cp_mtp27.style.display = 'none';
                                    cp_mtp28.style.display = 'none';
                                    cp_mtp29.style.display = 'none';
                                    ...
                                    cp_mtp11.style.display = 'none';
                                    cp_mtp12.style.display = 'none';
                                    cp_mtp13.style.display = 'none';
                                    cp_mtp21.style.display = 'none';
                                    cp_mtp22.style.display = 'none';
                                    cp_mtp23.style.display = 'none';
                                    cp_mtp3.style.display = 'none';
                                    cp_mtp4.style.display = 'none';
                                    cp_mtp5.style.display = 'none';
                                    cp_mtp6.style.display = 'none';
                                    ...
                                    cp_mtp14.style.display = 'block';
                                    cp_mtp15.style.display = 'block';
                                    cp_mtp16.style.display = 'block';
                                    cp_mtp17.style.display = 'block';
                                    cp_mtp18.style.display = 'block';
                                    cp_mtp19.style.display = 'block';
                                    cp_mtp24.style.display = 'block';
                                    cp_mtp25.style.display = 'block';
                                    cp_mtp26.style.display = 'block';
                                    cp_mtp27.style.display = 'block';
                                    cp_mtp28.style.display = 'block';
                                    cp_mtp29.style.display = 'block';
                                    cp_rh1.style.display = 'none';
                                    cp_rh2.style.display = 'none';
                                    cp_rh3.style.display = 'none';
                                    cp_rh4.style.display = 'none';
                    ...
                    <div class="tab-content" id="tabCpbl">
                        <div class="row">
                            ...
                            <div class="one columns" id="labelvoltrating4">&nbsp;</div>
                            ...
                            <div class="one columns" id="labelcoltcontrol4">&nbsp;</div>
                        </div>
                        <div class="row">
                            ...
                            <div class="one columns" id="labelcurrrating4">&nbsp;</div>
                            ...
                            <div class="one columns" id="labelpowerrating4">&nbsp;</div>
                        </div>
                        <div class="row">
                            ...
                            <div class="one columns" id="labelmintimer4">&nbsp;</div>
                            ...
                            <div class="one columns" id="labelmaxtimer4">&nbsp;</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="two columns"><label for="min_temp" id="labelmintemp4">Min. Temperature [Hot]</label></div>
                            <div class="two columns"><input type="number" step="0.001" id="min_temp_hot" name="min_temp_hot" value="<?php echo $rowForm['min_temp']; ?>" > </div>
                            <div class="one columns"><label for="min_temp" id="labelmintemp5" style="text-align: left"><b>&#176;C</b></label></div>
                            <div class="one columns" id="labelmintemp6">&nbsp;</div>
                            <div class="two columns"><label for="max_temp" id="labelmaxtemp4">Max. Temperature [Hot]</label></div>
                            <div class="two columns"><input type="number" step="0.001" id="max_temp_hot" name="max_temp_hot" value="<?php echo $rowForm['max_temp']; ?>" > </div>
                            <div class="one columns"><label for="max_temp" id="labelmaxtemp5" style="text-align: left"><b>&#176;C</b></label></div>
                            <div class="one columns" id="labelmaxtemp6">&nbsp;</div>
                        </div>
                        <div class="row">
                            <div class="two columns"><label for="min_temp" id="labelmintemp7">Min. Temperature [Cold]</label></div>
                            <div class="two columns"><input type="number" step="0.001" id="min_temp_cold" name="min_temp_cold" value="<?php echo $rowForm['min_temp_cold']; ?>" > </div>
                            <div class="one columns"><label for="min_temp" id="labelmintemp8" style="text-align: left"><b>&#176;C</b></label></div>
                            <div class="one columns" id="labelmintemp9">&nbsp;</div>
                            <div class="two columns"><label for="max_temp" id="labelmaxtemp7">Max. Temperature [Cold]</label></div>
                            <div class="two columns"><input type="number" step="0.001" id="max_temp_cold" name="max_temp_cold" value="<?php echo $rowForm['max_temp_cold']; ?>" > </div>
                            <div class="one columns"><label for="max_temp" id="labelmaxtemp8" style="text-align: left"><b>&#176;C</b></label></div>
                            <div class="one columns" id="labelmaxtemp9">&nbsp;</div>
                        </div>
                        <div class="row">
            ...
            form.addEventListener('input', () => {
                if (hasAllRequiredFilled()) {
                    if (hasAllVisibleFilled()) {
                        ...
                        console.log("SINI JADI DRAFT LAGI");
                        draftButton.style.display = 'block';
                        saveButton.style.display = 'none';
                    }
                } else {
                    console.log("AIK< TAKKAN SINI LAGI");
                    draftButton.style.display = 'none';
                    saveButton.style.display = 'none';
                }
            });
