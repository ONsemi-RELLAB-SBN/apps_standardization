...
<!--                        <input type="text" list="model_list" autocomplete="off" id="model" name="model">
                ...
                <button type="submit" id="allbutton" class="btn btn-primary u-pull-left"><i class='bx bx-send bx-fw' ></i> ALL</button>
                <button type="submit" id="draft-button" class="btn btn-primary u-pull-left"><i class='bx bx-send bx-fw' ></i> DRAFT</button>
                <button type="submit" id="save-button" class="btn btn-primary u-pull-left"><i class='bx bx-send bx-fw' ></i> SAVE</button>
...
//
//            // THIS ONE CHECK FOR ALL REQUIRED FIELD
//            form.addEventListener('change', () => {
//                var isFormValid = form.checkValidity();
//                var isAll = Array.from(form.querySelectorAll('input, select, textarea'));
//                draftButton.style.display = !isFormValid && form.elements.length > 0 ? 'block' : 'none';
//                saveButton.style.display = isFormValid ? 'block' : 'none';
//                if (isAll.every(field => field.value)) {
...
//            const form = document.getElementById('add_equipment_form');
//
//            // Identify visible fields and required fields
...
//                const saveButton = document.getElementById('save-button');
//
//                if (visibleFields.every(field => field.value)) {
//                    console.log("SINI SEMUA FIELD"+ field);
//                    draftButton.style.display = 'none';
//                    saveButton.style.display = 'block';
//                } else if (requiredFields.every(field => field.value)) {
//                    draftButton.style.display = 'block';
//                    console.log("SINI REQUIRED DONE");
//                } else {
//                    console.log("NI MANA?");
//                    draftButton.style.display = 'none';
//                    saveButton.style.display = 'none';
...
//            }
//
//            // Update button visibility on form change
//            form.addEventListener('change', () => {
...
//              const requiredFields = document.querySelectorAll('#add_equipment_form input[required], #add_equipment_form select[required]');
...
//            function hasAllFilled() {
//              const allFields = document.querySelectorAll('#add_equipment_form input, #add_equipment_form select');
...
//                  console.log("OK, REQUIRED DONE");
//                draftButton.style.display = 'block';
//              } else {
//                  console.log("ADA LAGI, CHECK");
//                draftButton.style.display = 'none';
//              }
//
//              if (hasAllFilled()) {
//                  console.log("SEMUA DA ISI");
//                draftButton.style.display = 'none';
//                saveButton.style.display = 'block';
//              } else {
//                  console.log("MASUK ADA KSONG");
//                saveButton.style.display = 'none';
//              }
//            });
  ...
  //              return [...visibleInputs, ...visibleSelects].every(input => input.value);
            ...
            function hasAllRequiredFilled() {
                // Filter out hidden and disabled required inputs
