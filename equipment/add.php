...
//                                if (reltest === '008016') {                               // PTC
                    ...
                    <div class="tab-content" id="tabCpbl">
                        ...
                        <div class="row">
                            ...
                            <div class="two columns"><input type="number" step="0.001" id="min_temp_hot" name="min_temp_hot" value="" > </div>
                            ...
                            <div class="two columns"><input type="number" step="0.001" id="max_temp_hot" name="max_temp_hot" value="" > </div>
                        ...
                        <div class="row">
                            ...
                            <div class="two columns"><input type="number" step="0.001" id="min_temp_cold" name="min_temp_cold" value="" > </div>
                            ...
                            <div class="two columns"><input type="number" step="0.001" id="max_temp_cold" name="max_temp_cold" value="" > </div>
